  ...
  return (
    <AuroraBackground>
      <div className="p-6 max-w-6xl mx-auto relative z-20">
        <h1 className="text-4xl font-bold mb-6 text-center">Welcome to English Test Platform</h1>
        <p className="text-xl text-center mb-10 max-w-3xl mx-auto">
          Improve your English speaking skills with our AI-powered practice tests. 
